...
const schema = yup.object({
    ...
    videoFile: yup.mixed()
        ...
        .test("is-video", "Please select a valid video file", (value) => {
...
const ExerciseCreationModal = ({ show, onClose, muscleGroups, exercises, onCreate }: Props) => {
    ...
    const onSubmit: SubmitHandler<FormData> = (data) => {
        ...
        const parsedData = { ...data, videoFile: data.videoFile[0] }
        setIsLoading(true);
        exerciseService.createExercise(parsedData).then((response) => {
